...
var Utils = (function () {
    ...
    Utils.prototype.getDate = function () {
        var dateTimeParts = new Date().toISOString().split('T');
    ...
    ;
    Utils.prototype.log = function (severity, message, data) {
        var logentry = "[LOG] " + "(" + severity + "): " + message;
        if (data) {
            logentry += "\n... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ... ...\n";
    ...
    ;
    Utils.prototype.callAPI = function (method, url, headers, data) {
        var axiosObj = {};
    ...
    ;
    Utils.prototype.callOpenAI = function (llmConfig, prompt) {
